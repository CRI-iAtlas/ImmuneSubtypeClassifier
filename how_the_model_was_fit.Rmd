...
and feature selection is done by a rank sum test.

To fit the ensemble model (list of subtype models):

```{r}
xbgParams <- list(max_depth = 5, eta = 0.3, nrounds = 150, nthread = 5, nfold=5, subsample=0.85)
ens <- fitEnsembleModel(Xmat, Y, n=5, sampSize=0.7, breakVec=c(0, 0.25, 0.5, 0.75, 1.0), params=xbgParams)
    ```
